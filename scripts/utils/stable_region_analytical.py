...
class StableRegion:
    ...
    def __init__(self, input_points, contact_points, contact_normals, default_mu=0.5):
        ...
        # input_points = input_points[range(0, len(input_points), 4)]
        # print(input_points.shape)
        # Input coordinates
    ...
    def is_stable_in_local_frame(self, local_xy):
        ...
        # Left-hand ICR
        constraints_L = [self._cond_FL11, self._cond_FL12, self._cond_FL21, self._cond_FL22]
        constraints_R = [self._cond_FR11, self._cond_FR12, self._cond_FR21, self._cond_FR22]
    ...
    def update_wrench_stable(self):
        ...
        self._cond_WL1.update(farpoint1, lper[1])  # passpoint, angle
        ...
        self._cond_WR2.update(farpoint2, rper[1])  # passpoint, angle
